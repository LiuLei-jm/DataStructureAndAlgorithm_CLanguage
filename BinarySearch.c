...
int binarySearchRecursion(int key, List *list, int start, int end)
{
    ...
    {
        start = mid + 1;
        return binarySearchRecursion(key, list, start, end);
    }
    else if (list->data[mid] > key)
    {
        end = mid - 1;
...
int main()
{
    ...
    printf("index:%d\n", binarySearchRecursion(3, list, 0, list->num - 1));
    printf("index:%d\n", binarySearchRecursion(10, list, 0, list->num - 1));
    printf("index:%d\n", binarySearchRecursion(1, list, 0, list->num - 1));
